...
const FAQScreen = props => {
    const faq = [
        ...
        { q: "Muss ich meine eBay - Anmeldedaten angeben, um eine Auktionsvorlage aus meinen existierenden eBay - Inseraten erstellen zu können?", a: "Die Antwort ist auch hier ein klares NEIN.Sie werden an keiner Stelle von Auction Template aufgefordert, Ihre persönlichen eBay - Anmeldedaten preiszugeben.Auction Template ist offizieller Partner des eBay Developers Programs und hält sich zu 100 % an die Nutzungsichtlinien der offiziellen eBay API." },
        { q: "Wie lange ist der Supportzeitraum nach Kauf einer Auktionsvorlage?", a: "Prinzipiell gilt: Sie können Auction Template zu jeder Zeit bei Fragen, Problemen oder Anregungen kontaktieren." },
        { q: "Kann eine Auktionsvorlage nach der Generierung ohne HTML - /Programmierkenntnisse bearbeitet werden?", a: "Jede unserer Auktionsvorlagen bietet großen Bearbeitungsspielraum: sei es das Ändern des Farbschemas oder des Preises, durch unseren fortschrittlichen Online - Editor können Elemente einer Auktionsvorlage verändert, verschoben oder gelöscht werden." },
        { q: "Kann ich Auktionsvorlagen vor dem Kauf testen?", a: "Im Shop erhalten Sie bereits einen vollständigen visuellen Eindruck der gewünschten Auktionsvorlage.Wenn Sie Auction Template vor Kauf einer Auktionsvorlage vollständig testen wollen, können Sie gerne eine unserer umfangreichen, kostenlosen Auktionsvorlagen ausprobieren." },
        { q: "Aktualisieren sich Inhalte einer generierten Auktionsvorlage automatisch?", a: "Auction Template befolgt penibel die offiziellen Richtlinien von eBay, somit entfällt eine automatische Aktualisierung einer Auktionsvorlage, da dies gezwungenermaßen den Einsatz von aktiven Inhalten nach sich ziehen würde, welches von eBay zum aktuellen Zeitpunkt zu Ihrem eigenen und den Schutz Ihrer Kunden verboten wird." },
        { q: "Personalisierung Ihrer Auktionsvorlage", a: "Sie möchten eine personalisierte / individualisierte Auktionsvorlage nach Ihren eigenen Wünschen & Maßstäben ? Wir helfen Ihnen gerne weiter und erstellen Ihnen Ihre eigene automatisierte, individuelle Auktionsvorlage: info@dem-it.de" },
        { q: "Habe ich ein Rückgaberecht, falls mir eine Auktionsvorlage nicht gefällt?", a: "Grundsätzlich gilt: Sie erhalten auf jede gekaufte Auktionsvorlage ein 14 - tägiges Rückgaberecht.Wenn Sie mit Auction Template nicht zufrieden sind, können Sie Ihren Kauf innerhalb von 14 Tagen nach dem Bezahldatum widerrufen und erhalten eine vollständige Erstattung des Kaufpreises.Eine Rückgabe nach der 14 - tägigen Frist ist nicht mehr möglich.Weitere Informationen hierzu finden Sie in den AGBs." }
    ]
    return (
        <StyledPage style={{ backgroundColor: "#e6e6e6", height: "100vh" }} >
