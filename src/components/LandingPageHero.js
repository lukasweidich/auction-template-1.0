...
const Hero = props => {
    return <div className="auction-template-landing-container">
        <div class="auction-template-background-lines">
            <div class="auction-template-landing-wrapper">
        ...
        <div class="auction-template-landing-rocket">
        </div>
    </div>
}
export default Hero